...
const SingleAssignment = ({ assignment }) => {
  const { id, video_title, title, totalMark } = assignment;
  const [deleteAssginment] = useDeleteAssignmentMutation();

  let arr = video_title.split(" ");
  let v_title = "";
  ...
  return (
    <tr>
      ...
      <td className="table-td">{v_title}</td>
